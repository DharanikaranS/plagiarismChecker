        ...
        <input  className='c-title-input' type='text' id='c-title' autoComplete='off' required value={title} onChange={(e)=>setTitle(e.target.value)} placeholder='TITLE'></input>
            ...
            <div className='text1'>
              <div className='t1'>
                ...
                <p>DOCUMENT 1</p>
                <p className='text-logo'><FaRegFilePdf className='text-logo'/> <span >UPLOAD PDF </span></p>
                
                <div
                className='input-text1-pdf'
                ><div class="excel2"
    
                ><label className='i2' htmlFor='i1'>UPLOAD YOUR PDF SHEET 1</label>
                <div className='pdf1-file-choosen'>{file1?file1.name:'NO FILE CHOOSEN'}</div>
                <input onChange={(event)=>{
                  setFile1(event.target.files[0])
                 

                }} required accept='.pdf' id='i1' type='file' placeholder='ENTER FILE 1'/>
                ...
                ><label  className='i2' htmlFor='i2'>UPLOAD YOUR PDF SHEET 2</label>
                <div className='pdf1-file-choosen'>{file2?file2.name:'NO FILE CHOOSEN'}</div>
                <input onChange={(event)=>{
                   setFile2(event.target.files[0])
                }} required accept='.pdf' id='i2' type='file' placeholder='ENTER FILE 2'/>
                </div>
